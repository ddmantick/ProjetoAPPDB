...
class Usuarios:
    # Simulação de banco de dados para fins de demonstração
    db = {
        '1': {'nome': 'João', 'telefone': '123456789', 'email': 'joao@example.com', 'usuario': 'joao123',
              'senha': 'senha123'},
        '2': {'nome': 'Maria', 'telefone': '987654321', 'email': 'maria@example.com', 'usuario': 'maria123',
              'senha': 'senha456'}
    }
